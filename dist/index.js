...
async function klingRequest(path, init = {}) {
...
server.tool("kling_text_to_video", "Create a Kling AI text-to-video generation task.", {
...
server.tool("kling_image_to_video", "Create a Kling AI image-to-video generation task. image must be a URL or base64 string accepted by Kling.", {
